...
extension TitleSource {
    var label: String {
        switch self {
        case .custom: return "Name you set"
        case .agentName: return "Agent name"
        case .generated: return "Title generated by the agent"
        case .firstPrompt: return "From the opening prompt"
        case .lastPrompt: return "From the latest prompt"
        case .none: return "No title — showing the project"
        }
    }
    var systemImage: String {
        switch self {
        case .custom: return "pencil"
        case .agentName: return "person.crop.square"
        case .generated: return "wand.and.stars"
        case .firstPrompt, .lastPrompt: return "text.quote"
